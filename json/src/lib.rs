...
use luckycoin::consensus::encode;
use luckycoin::hashes::hex::{FromHex, ToHex};
use luckycoin::hashes::sha256;
use luckycoin::util::{bip158, bip32};
use luckycoin::{Address, Amount, PrivateKey, PublicKey, Script, SignedAmount, Transaction};
...
pub struct GetNetworkInfoResult {
    ...
    #[serde(rename = "relayfee", with = "luckycoin::util::amount::serde::as_btc")]
    pub relay_fee: Amount,
    #[serde(rename = "incrementalfee", with = "luckycoin::util::amount::serde::as_btc")]
...
pub struct GetWalletInfoResult {
    ...
    #[serde(with = "luckycoin::util::amount::serde::as_btc")]
    pub balance: Amount,
    #[serde(with = "luckycoin::util::amount::serde::as_btc")]
    ...
    #[serde(rename = "paytxfee", with = "luckycoin::util::amount::serde::as_btc")]
    pub pay_tx_fee: Amount,
    #[serde(rename = "hdseedid")]
    pub hd_seed_id: Option<luckycoin::XpubIdentifier>,
...
pub struct GetBlockResult {
    ...
    pub merkleroot: luckycoin::TxMerkleNode,
    pub tx: Vec<luckycoin::Txid>,
    pub time: usize,
    ...
    pub n_tx: usize,
    pub previousblockhash: Option<luckycoin::BlockHash>,
    pub nextblockhash: Option<luckycoin::BlockHash>,
}
...
pub struct GetBlockHeaderResult {
    ...
    pub merkle_root: luckycoin::TxMerkleNode,
    pub time: usize,
    ...
    pub previous_block_hash: Option<luckycoin::BlockHash>,
    #[serde(rename = "nextblockhash")]
    pub next_block_hash: Option<luckycoin::BlockHash>,
}

#[derive(Clone, PartialEq, Debug, Deserialize, Serialize)]
pub struct GetBlockStatsResult {
    #[serde(rename = "avgfee", with = "luckycoin::util::amount::serde::as_sat")]
    pub avg_fee: Amount,
    #[serde(rename = "avgfeerate", with = "luckycoin::util::amount::serde::as_sat")]
    pub avg_fee_rate: Amount,
    #[serde(rename = "avgtxsize")]
    pub avg_tx_size: u32,
    #[serde(rename = "blockhash")]
    pub block_hash: luckycoin::BlockHash,
    #[serde(rename = "feerate_percentiles")]
    pub fee_rate_percentiles: FeeRatePercentiles,
    pub height: u64,
    pub ins: usize,
    #[serde(rename = "maxfee", with = "luckycoin::util::amount::serde::as_sat")]
    pub max_fee: Amount,
    #[serde(rename = "maxfeerate", with = "luckycoin::util::amount::serde::as_sat")]
    pub max_fee_rate: Amount,
    #[serde(rename = "maxtxsize")]
    pub max_tx_size: u32,
    #[serde(rename = "medianfee", with = "luckycoin::util::amount::serde::as_sat")]
    pub median_fee: Amount,
    #[serde(rename = "mediantime")]
    pub median_time: u64,
    #[serde(rename = "mediantxsize")]
    pub median_tx_size: u32,
    #[serde(rename = "minfee", with = "luckycoin::util::amount::serde::as_sat")]
    pub min_fee: Amount,
    #[serde(rename = "minfeerate", with = "luckycoin::util::amount::serde::as_sat")]
    pub min_fee_rate: Amount,
    #[serde(rename = "mintxsize")]
    pub min_tx_size: u32,
    pub outs: usize,
    #[serde(with = "luckycoin::util::amount::serde::as_sat")]
    pub subsidy: Amount,
    ...
    #[serde(rename = "totalfee", with = "luckycoin::util::amount::serde::as_sat")]
...
pub struct GetBlockStatsResultPartial {
    #[serde(
        default,
        rename = "avgfee",
        with = "luckycoin::util::amount::serde::as_sat::opt",
    ...
    pub block_hash: Option<luckycoin::BlockHash>,
...
pub struct GetRawTransactionResultVin {
    ...
    pub txid: Option<luckycoin::Txid>,
    /// Not provided for coinbase txs.
    pub vout: Option<u32>,
...
pub struct GetRawTransactionResult {
    ...
    #[serde(with = "crate::serde_hex")]
    pub hex: Vec<u8>,
    pub txid: luckycoin::Txid,
    pub hash: luckycoin::Wtxid,
    pub size: usize,
    pub vsize: usize,
    pub version: u32,
    pub locktime: u32,
    ...
    pub blockhash: Option<luckycoin::BlockHash>,
...
pub struct GetBlockFilterResult {
    pub header: luckycoin::FilterHash,
    #[serde(with = "crate::serde_hex")]
    pub filter: Vec<u8>,
}
...
pub struct GetTransactionResultDetail {
    ...
    pub vout: u32,
    #[serde(default, with = "luckycoin::util::amount::serde::as_btc::opt")]
...
pub struct WalletTxInfo {
    ...
    pub wallet_conflicts: Vec<luckycoin::Txid>,
}
...
pub struct ListSinceBlockResult {
    ...
    pub lastblock: luckycoin::BlockHash,
}

#[derive(Clone, PartialEq, Eq, Debug, Deserialize, Serialize)]
#[serde(rename_all = "camelCase")]
pub struct GetTxOutResult {
    pub bestblock: luckycoin::BlockHash,
...
pub struct ListUnspentQueryOptions {
    #[serde(
        ...
        with = "luckycoin::util::amount::serde::as_btc::opt",
        skip_serializing_if = "Option::is_none"
    )]
...
pub struct GetBlockchainInfoResult {
    ...
    pub best_block_hash: luckycoin::BlockHash,
...
pub struct GetMempoolEntryResult {
    ...
    pub wtxid: luckycoin::Txid,
    /// Fee information
    pub fees: GetMempoolEntryResultFees,
    /// Unconfirmed transactions used as inputs for this transaction
    pub depends: Vec<luckycoin::Txid>,
    /// Unconfirmed transactions spending outputs from this transaction
    #[serde(rename = "spentby")]
    pub spent_by: Vec<luckycoin::Txid>,
...
pub struct GetPeerInfoResult {
    ...
    #[serde(rename = "minfeefilter", default, with = "luckycoin::util::amount::serde::as_btc::opt")]
...
pub struct GetBlockTemplateResult {
    ...
    #[serde(rename = "previousblockhash")]
    pub previous_block_hash: luckycoin::BlockHash,
    ...
    #[serde(default, with = "luckycoin::blockdata::script::Script")]
    pub signet_challenge: luckycoin::blockdata::script::Script,
    ...
    /// is activated.
    #[serde(with = "luckycoin::blockdata::script::Script", default)]
    pub default_witness_commitment: luckycoin::blockdata::script::Script,
    ...
    #[serde(rename = "coinbasevalue", with = "luckycoin::util::amount::serde::as_sat", default)]
...
/// A wrapper around luckycoin::EcdsaSighashType that will be serialized
/// according to what the RPC expects.
pub struct SigHashType(luckycoin::EcdsaSighashType);

impl From<luckycoin::EcdsaSighashType> for SigHashType {
    fn from(sht: luckycoin::EcdsaSighashType) -> SigHashType {
        SigHashType(sht)
    }
}
...
impl serde::Serialize for SigHashType {
        ...
        S: serde::Serializer,
    {
        serializer.serialize_str(match self.0 {
            luckycoin::EcdsaSighashType::All => "ALL",
            luckycoin::EcdsaSighashType::None => "NONE",
            luckycoin::EcdsaSighashType::Single => "SINGLE",
            luckycoin::EcdsaSighashType::AllPlusAnyoneCanPay => "ALL|ANYONECANPAY",
            luckycoin::EcdsaSighashType::NonePlusAnyoneCanPay => "NONE|ANYONECANPAY",
            luckycoin::EcdsaSighashType::SinglePlusAnyoneCanPay => "SINGLE|ANYONECANPAY",
        })
    }
}
...
pub struct GetTxOutSetInfoResult {
    ...
    pub best_block: luckycoin::BlockHash,
...
pub struct ScanTxOutResult {
    ...
    pub height: Option<u64>,
    #[serde(rename = "bestblock")]
    pub best_block_hash: Option<luckycoin::BlockHash>,
    pub unspents: Vec<Utxo>,
    #[serde(with = "luckycoin::util::amount::serde::as_btc")]
    pub total_amount: luckycoin::Amount,
}
...
pub struct Utxo {
    pub txid: luckycoin::Txid,
    pub vout: u32,
    pub script_pub_key: luckycoin::Script,
    #[serde(rename = "desc")]
    pub descriptor: String,
    #[serde(with = "luckycoin::util::amount::serde::as_btc")]
    pub amount: luckycoin::Amount,
    pub height: u64,
}
